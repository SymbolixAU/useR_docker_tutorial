...
* ** 9:00 - 10:00** : A bit of a yarn<sup>*</sup>
...
# The .accent[R] and .accent[Docker] story
...
# The standard R environment

.image-50[ 
![Rlogo](images/R_logo.svg.png)
]


???

I hope we all have a basic answer about what R is and does, but I want to talk about what you really need to produce reproducible analysis system in R
...
# How does this container thing work?
...
# It's useful to think about VMs

<div class="myrow"> 
  <div class="mycolumn">
    <background-image: url="images/docker_doc.png">
  </div>
  <div class="mycolumn">
    <img src="images/docker_doc_img.png">
  </div> 
</div>
...
.footnote[[*] https://docs.docker.com/get-started/#recap-and-cheat-sheet ]
